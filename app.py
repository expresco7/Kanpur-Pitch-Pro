...
# App Header
st.markdown("<h1 class='header-text'>⚡ Team Kanpur 1 Pitch Book</h1>", unsafe_style_html=True)
st.markdown("<p style='text-align: center; color: #666;'>Kyunki baat Izzat ki hai! Instant Field Guides & Audio Tracks</p>", unsafe_style_html=True)
st.write("---")
...
data = {
    ...
    "Merchant Lending": {
        ...
        "Banks": {
            ...
            "audio": "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3"  # Dummy audio URL placeholder
        }
    }
}
...
st.markdown("<div class='points-card'><b>📋 Actual Points to Discuss:</b></div>", unsafe_style_html=True)
...
# 2. Verbal Pitch Card
st.markdown("<div class='pitch-card'><b>🗣️ Verbal Pitch (Izhar Style):</b><br><br>" + selected_data['pitch'] + "</div>", unsafe_style_html=True)
...
st.write("---")
st.markdown("<p style='text-align: center; font-size: 12px; color: #aaa;'>PhonePe Kanpur 1 Internal Operational App v1.2</p>", unsafe_style_html=True)
